...
<Sidebar position={SidebarPosition.left} expandedWidth="280px">
  ...
  <ul slot="expanded_main" class="list-none p-0 m-0">
    {#each links as link}
      <li class="m-0 py-3">
        <a href={link.href} class="text-decoration-none text-black flex items-center font-normal text-3xl h-8">
  ...
  <a slot="collapsed_bottom" href="/static"
     class="text-decoration-none text-black flex items-center font-normal text-3xl w-full h-8">
    <Icon icon="mdi:settings" />
  </a>

  <a slot="expanded_bottom" href="/static"
     class="text-decoration-none text-black flex items-center font-normal text-3xl w-full h-8">
