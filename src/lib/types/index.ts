import { Skill } from "$lib/types/skill.ts";
import { Person, type PersonProps } from "$lib/types/person.ts";
...
export { Skill, Person, Location, Task, Shift, type PersonProps, type Constraint };
